...
class Add:   
    ...
    def show(self):    
        ...
        self.entry_id = tk.Entry(self.frame_id, textvariable=self.id, font=('Arial', 9), width=25, bd=3, bg='#F3F4F6', highlightthickness=1, relief=tk.FLAT)
        ...
        self.entry_name = tk.Entry(self.frame_name, textvariable=self.name, font=('Arial', 9), width=25, bd=3,  bg='#FFFFFF', highlightthickness=1, relief=tk.FLAT)
        ...
        self.entry_gender = tk.Entry(self.frame_gender, textvariable=self.gender, font=('Arial', 9), width=25, bd=3, bg='#F3F4F6', highlightthickness=1, relief=tk.FLAT)
        self.entry_gender.grid(row=0, column=1, padx=10, pady=0)
        ...
        self.entry_course = tk.Entry(self.frame_course, textvariable=self.course, font=('Arial', 9), width=25, bd=3, bg='#FFFFFF', highlightthickness=1, relief=tk.FLAT)
        self.entry_course.grid(row=0, column=1, padx=10, pady=0)
        ...
        self.entry_year = tk.Entry(self.frame_year, textvariable=self.year, font=('Arial', 9), width=25, bd=3, bg='#F3F4F6', highlightthickness=1, relief=tk.FLAT)
        self.entry_year.grid(row=0, column=1, padx=10, pady=0)
        ...
        self.entry_birthdate = tk.Entry(self.frame_birthdate, textvariable=self.birthdate, font=('Arial', 9), width=25, bd=3, bg='#FFFFFF', highlightthickness=1, relief=tk.FLAT)
        self.entry_birthdate.grid(row=0, column=1, padx=10, pady=0)
        ...
        self.entry_address = tk.Entry(self.frame_address, textvariable=self.address, font=('Arial', 9), width=25, bd=3, bg='#F3F4F6', highlightthickness=1, relief=tk.FLAT)
        self.entry_address.grid(row=0, column=1, padx=10, pady=0)
        ...
        self.entry_contact = tk.Entry(self.frame_contact, textvariable=self.contact, font=('Arial', 9), width=25, bd=3, bg='#FFFFFF', highlightthickness=1, relief=tk.FLAT)
        self.entry_contact.grid(row=0, column=1, padx=10, pady=0)
    ...
    def add(self):       
        if messagebox.askquestion('Add Student', 'Are you sure you want to add this student?') == 'yes':
            if self.empty():
                ...
                if self.id.get() in self.database.keys():
                    self.id.set('')
                    ...
                    messagebox.showinfo('Delete Student', 'Student added.')
