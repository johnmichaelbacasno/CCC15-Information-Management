...
class View:    
    ...
    def show(self):       
        self.id.set(self.database.search(self.key, attr='id'))
        self.name.set(self.database.search(self.key, attr='name'))
        self.gender.set(self.database.search(self.key, attr='gender'))
        self.course.set(self.database.search(self.key, attr='course'))
        self.year.set(self.database.search(self.key, attr='year'))
        self.birthdate.set(self.database.search(self.key, attr='birthdate'))
        self.contact.set(self.database.search(self.key, attr='contact'))
        self.address.set(self.database.search(self.key, attr='address'))
        ...
        self.entry_id = tk.Entry(self.frame_id, textvariable=self.id, font=('Arial', 9), width=25, bd=0, bg='#F3F4F6', highlightthickness=0, state='disabled', disabledbackground='#F3F4F6', disabledforeground='#000000')
        ...
        self.entry_name = tk.Entry(self.frame_name, textvariable=self.name, font=('Arial', 9), width=25, bd=0, bg='#FFFFFF', highlightthickness=0)
        ...
        self.entry_gender = tk.Entry(self.frame_gender, textvariable=self.gender, font=('Arial', 9), width=25, bd=0, bg='#F3F4F6', highlightthickness=0)
        ...
        self.entry_course = tk.Entry(self.frame_course, textvariable=self.course, font=('Arial', 9), width=25, bd=0, bg='#FFFFFF', highlightthickness=0)
        self.entry_course.grid(row=0, column=1, padx=10, pady=5)
        ...
        self.entry_year = tk.Entry(self.frame_year, textvariable=self.year, font=('Arial', 9), width=25, bd=0, bg='#F3F4F6', highlightthickness=0)
        ...
        self.entry_birthdate = tk.Entry(self.frame_birthdate, textvariable=self.birthdate, font=('Arial', 9), width=25, bd=0, bg='#FFFFFF', highlightthickness=0)
        ...
        self.entry_address = tk.Entry(self.frame_address, textvariable=self.address, font=('Arial', 9), width=25, bd=0, bg='#F3F4F6', highlightthickness=0)
        ...
        self.entry_contact = tk.Entry(self.frame_contact, textvariable=self.contact, font=('Arial', 9), width=25, bd=0, bg='#FFFFFF', highlightthickness=0)
        ...
        self.button_update.grid(row=0, column=0, padx=10, pady=18)
    ...
    def update(self): 
        if self.empty():
            ...
            messagebox.showinfo('Student Profile', 'Student updated.')
            self.show()
